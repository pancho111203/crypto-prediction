...
sys.path.append('/Users/RUBI349500/Projects/ML/pytorch/utils/helpers')
...
if not args.visualize_results:
    for epoch in range(start_epoch, start_epoch+3000):
        ...
        metrics.track({'epoch': epoch, 'timeTaken': timeTaken, 'train_loss': train_loss, 'test_loss': test_loss })
